    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 md:gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 md:p-6">
            <div class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
                <svg class="fill-gray-800 dark:fill-white/90" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5229 6.47715 22 12 22C17.5229 22 22 17.5229 22 12C22 6.47715 17.5229 2 12 2ZM9 8C9 6.89543 9.89543 6 11 6H13C14.1046 6 15 6.89543 15 8V16C15 17.1046 14.1046 18 13 18H11C9.89543 18 9 17.1046 9 16V8ZM11 8H13V16H11V8Z" fill=""/>
                </svg>
            </div>
            <div class="flex items-end justify-between mt-5">
                <div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 md:p-6">
            <div class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
                <svg class="fill-gray-800 dark:fill-white/90" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 5.25C4 4.00736 5.00736 3 6.25 3H17.75C18.9926 3 20 4.00736 20 5.25V18.75C20 19.9926 18.9926 21 17.75 21H6.25C5.00736 21 4 19.9926 4 18.75V5.25ZM6.25 4.5C5.83579 4.5 5.5 4.83579 5.5 5.25V18.75C5.5 19.1642 5.83579 19.5 6.25 19.5H17.75C18.1642 19.5 18.5 19.1642 18.5 18.75V5.25C18.5 4.83579 18.1642 4.5 17.75 4.5H6.25ZM7.75 7.5C7.33579 7.5 7 7.83579 7 8.25V9.75C7 10.1642 7.33579 10.5 7.75 10.5H16.25C16.6642 10.5 17 10.1642 17 9.75V8.25C17 7.83579 16.6642 7.5 16.25 7.5H7.75ZM7 13.5C7 13.0858 7.33579 12.75 7.75 12.75H16.25C16.6642 12.75 17 13.0858 17 13.5V14.25C17 14.6642 16.6642 15 16.25 15H7.75C7.33579 15 7 14.6642 7 14.25V13.5Z" fill=""/>
                </svg>
            </div>
            <div class="flex items-end justify-between mt-5">
                <div>
                    <span class ="text-sm text-gray-500 dark:text-gray-400">Total Laporan</span>
                    <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">
                        {{ $totalReports }}
                    </h4>
                </div>
