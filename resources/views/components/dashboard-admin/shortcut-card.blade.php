<a href="{{ route('admin.classes.index') }}"
    ...
    <div
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 4.5V10M10 10V15.5M10 10H15.5M10 10H4.5" stroke="currentColor" stroke-width="1.5"
...
<a href="{{ route('admin.classes.index') }}"
    ...
    <div
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 7H16M4 12H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
...
<a href="{{ route('admin.schedule.index') }}"
    ...
    <div
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 8H14M6 12H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
...
<a href="{{ route('admin.report.index') }}"
    ...
    <div
        ...
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 6H15M5 10H15M5 14H11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
        </svg>
    </div>
    <p class="mt-4 text-sm font-semibold text-gray-900 dark:text-white/90">Cek Laporan</p>
</a>
