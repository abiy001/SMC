...
<div class="flex items-center gap-2">
     ...
     <a href="{{ route('admin.waka.create') }}"
    ...
    <a href="{{ route('admin.waka.template') }}"
 ...
 <div id="import-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <div class="w-full max-w-md rounded-xl bg-white p-6 dark:bg-gray-900">
        <h3 class="mb-4 text-base font-medium text-gray-800 dark:text-white/90">Import Data Waka</h3>

        <form action="{{ route('admin.waka.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div>
